...
export const ContactSection = () => {
  ...
  const socialLinks = [
    { name: "Email", icon: "✉️", action: handleEmailClick },
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        {/* Footer */}
        <div className={cn(
          "mt-20 pt-8 border-t border-border text-center transition-all duration-700 delay-300",
          isVisible ? "opacity-100" : "opacity-0"
        )}>
          <p className="text-muted-foreground font-hand text-lg">
            Portfolio '24 • <span className="text-secondary">Yash Deshpande</span>
          </p>
        </div>
      </div>
    </section>
